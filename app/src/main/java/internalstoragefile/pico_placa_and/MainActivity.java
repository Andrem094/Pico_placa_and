package internalstoragefile.pico_placa_and;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(tv1.getText().toString().equals(" "+tv_placa.getText().toString()+" ")){
            tx4.setText("HOY TIENES PICO Y PLACA");
            tx4.setTextColor(Color.RED);
        }else {
            tx4.setText("HOY NO TIENES PICO Y PLACA");
            tx4.setTextColor(Color.YELLOW);
        }
    ...
    public  void imagen(){
        ...
        if(tv1.getText().equals(" 0 - 1 ")) {
            iv1.setImageResource(R.drawable.dia1);
        }

        if(tv1.getText().equals(" 2 - 3 ")) {
            iv1.setImageResource(R.drawable.dia2);
        }

        if(tv1.getText().equals(" 4 - 5 ")) {
            iv1.setImageResource(R.drawable.dia3);
        }

        if(tv1.getText().equals(" 6 - 7 ")) {
            iv1.setImageResource(R.drawable.dia4);
        }

        if(tv1.getText().equals(" 8 - 9 ")) {
            iv1.setImageResource(R.drawable.dia5);
        }

        if(tv1.getText().equals(" NO APLICA ")) {
            iv1.setImageResource(R.drawable.no_aplica);
        }
    }
}
